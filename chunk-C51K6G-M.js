import{Ar as qD,Dt as QE,F as G1,G as ID,Gn as gI,I as GE,Nn as ch,Ot as Qc,Pn as cy,Sn as _i,T as Dw,Wr as tw,X as Jp,Xr as vD,Yn as hh,Yr as uu,_r as nh,en as We,h as BD,ht as Nr,kr as q1,l as A,mn as Yu,n as $D,nr as jD,nt as Kp,ot as Lh,pn as Yp,qt as VD,si as z1,wn as _o,wr as oh,zt as T}from"./chunk-DoCXw7pv.js";import{I as _n,K as it,g as Mn,m as La,p as L,st as qn,w as Ua}from"./chunk-C0ZjEuHg.js";import{_ as ei}from"./main-NNA532GB.js";import{b as y,d as Y$1}from"./chunk-B9TYi4gO.js";var Y=[`switch`];var J=[`*`];function K(i,p){i&1&&(_i(0,`span`,11),Yu(),_i(1,`svg`,13),Jp(2,`path`,14),Qc(),_i(3,`svg`,15),Jp(4,`path`,16),Qc()())}var ee=new A(`mat-slide-toggle-default-options`,{providedIn:`root`,factory:()=>({disableToggleValue:!1,hideIcon:!1,disabledInteractive:!1})});var g=class{source;checked;constructor(p,t){this.source=p,this.checked=t}};var te=(()=>{class i{_elementRef=T(Nr);_focusMonitor=T(Mn);_changeDetectorRef=T(q1);defaults=T(ee);_onChange=t=>{};_onTouched=()=>{};_validatorOnChange=()=>{};_uniqueId;_checked=!1;_createChangeEvent(t){return new g(this,t)}_labelId;get buttonId(){return`${this.id||this._uniqueId}-button`}_switchElement;focus(){this._switchElement.nativeElement.focus()}_noopAnimations=_n();_focused=!1;name=null;id;labelPosition=`after`;ariaLabel=null;ariaLabelledby=null;ariaDescribedby;required=!1;color;disabled=!1;fullWidth=!1;disableRipple=!1;tabIndex=0;get checked(){return this._checked}set checked(t){this._checked=t,this._changeDetectorRef.markForCheck()}hideIcon;disabledInteractive;change=new We;toggleChange=new We;get inputId(){return`${this.id||this._uniqueId}-input`}constructor(){T(L).load(Ua);let t=T(new Lh(`tabindex`),{optional:!0}),a=this.defaults;this.tabIndex=t==null?0:parseInt(t)||0,this.color=a.color||`accent`,this.id=this._uniqueId=T(it).getId(`mat-mdc-slide-toggle-`),this.hideIcon=a.hideIcon??!1,this.disabledInteractive=a.disabledInteractive??!1,this._labelId=this._uniqueId+`-label`}ngAfterContentInit(){this._focusMonitor.monitor(this._elementRef,!0).subscribe(t=>{t===`keyboard`||t===`program`?(this._focused=!0,this._changeDetectorRef.markForCheck()):t||Promise.resolve().then(()=>{this._focused=!1,this._onTouched(),this._changeDetectorRef.markForCheck()})})}ngOnChanges(t){t.required&&this._validatorOnChange()}ngOnDestroy(){this._focusMonitor.stopMonitoring(this._elementRef)}writeValue(t){this.checked=!!t}registerOnChange(t){this._onChange=t}registerOnTouched(t){this._onTouched=t}validate(t){return this.required&&t.value!==!0?{required:!0}:null}registerOnValidatorChange(t){this._validatorOnChange=t}setDisabledState(t){this.disabled=t,this._changeDetectorRef.markForCheck()}toggle(){this.checked=!this.checked,this._onChange(this.checked)}_emitChangeEvent(){this._onChange(this.checked),this.change.emit(this._createChangeEvent(this.checked))}_handleClick(){this.disabled||(this.toggleChange.emit(),this.defaults.disableToggleValue||(this.checked=!this.checked,this._onChange(this.checked),this.change.emit(new g(this,this.checked))))}_getAriaLabelledBy(){return this.ariaLabelledby?this.ariaLabelledby:this.ariaLabel?null:this._labelId}static ɵfac=function(a){return new(a||i)};static ɵcmp=GE({type:i,selectors:[[`mat-slide-toggle`]],viewQuery:function(a,e){if(a&1&&ch(Y,5),a&2){let l;BD(l=$D())&&(e._switchElement=l.first)}},hostAttrs:[1,`mat-mdc-slide-toggle`],hostVars:15,hostBindings:function(a,e){a&2&&(nh(`id`,e.id),Yp(`tabindex`,null)(`aria-label`,null)(`name`,null)(`aria-labelledby`,null),tw(e.color?`mat-`+e.color:``),hh(`mat-mdc-slide-toggle-focused`,e._focused)(`mat-mdc-slide-toggle-checked`,e.checked)(`mat-slide-toggle-full-width`,e.fullWidth)(`_mat-animation-noopable`,e._noopAnimations))},inputs:{name:`name`,id:`id`,labelPosition:`labelPosition`,ariaLabel:[0,`aria-label`,`ariaLabel`],ariaLabelledby:[0,`aria-labelledby`,`ariaLabelledby`],ariaDescribedby:[0,`aria-describedby`,`ariaDescribedby`],required:[2,`required`,`required`,G1],color:`color`,disabled:[2,`disabled`,`disabled`,G1],fullWidth:[2,`fullWidth`,`fullWidth`,G1],disableRipple:[2,`disableRipple`,`disableRipple`,G1],tabIndex:[2,`tabIndex`,`tabIndex`,t=>t==null?0:z1(t)],checked:[2,`checked`,`checked`,G1],hideIcon:[2,`hideIcon`,`hideIcon`,G1],disabledInteractive:[2,`disabledInteractive`,`disabledInteractive`,G1]},outputs:{change:`change`,toggleChange:`toggleChange`},exportAs:[`matSlideToggle`],features:[Dw([{provide:Y$1,useExisting:_o(()=>i),multi:!0},{provide:y,useExisting:i,multi:!0}]),cy],ngContentSelectors:J,decls:14,vars:27,consts:[[`switch`,``],[`mat-internal-form-field`,``,3,`labelPosition`],[`role`,`switch`,`type`,`button`,1,`mdc-switch`,3,`click`,`tabIndex`,`disabled`],[1,`mat-mdc-slide-toggle-touch-target`],[1,`mdc-switch__track`],[1,`mdc-switch__handle-track`],[1,`mdc-switch__handle`],[1,`mdc-switch__shadow`],[1,`mdc-elevation-overlay`],[1,`mdc-switch__ripple`],[`mat-ripple`,``,1,`mat-mdc-slide-toggle-ripple`,`mat-focus-indicator`,3,`matRippleTrigger`,`matRippleDisabled`,`matRippleCentered`],[1,`mdc-switch__icons`],[1,`mdc-label`,3,`click`,`for`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--on`],[`d`,`M19.69,5.23L8.96,15.96l-4.23-4.23L2.96,13.5l6,6L21.46,7L19.69,5.23z`],[`viewBox`,`0 0 24 24`,`aria-hidden`,`true`,1,`mdc-switch__icon`,`mdc-switch__icon--off`],[`d`,`M20 13H4v-2h16v2z`]],template:function(a,e){if(a&1&&(jD(),_i(0,`div`,1)(1,`button`,2,0),oh(`click`,function(){return e._handleClick()}),Jp(3,`div`,3)(4,`span`,4),_i(5,`span`,5)(6,`span`,6)(7,`span`,7),Jp(8,`span`,8),Qc(),_i(9,`span`,9),Jp(10,`span`,10),Qc(),vD(11,K,5,0,`span`,11),Qc()()(),_i(12,`label`,12),oh(`click`,function($){return $.stopPropagation()}),VD(13),Qc()()),a&2){let l=qD(2);Kp(`labelPosition`,e.labelPosition),gI(),hh(`mdc-switch--selected`,e.checked)(`mdc-switch--unselected`,!e.checked)(`mdc-switch--checked`,e.checked)(`mdc-switch--disabled`,e.disabled)(`mat-mdc-slide-toggle-disabled-interactive`,e.disabledInteractive),Kp(`tabIndex`,e.disabled&&!e.disabledInteractive?-1:e.tabIndex)(`disabled`,e.disabled&&!e.disabledInteractive),Yp(`id`,e.buttonId)(`name`,e.name)(`aria-label`,e.ariaLabel)(`aria-labelledby`,e._getAriaLabelledBy())(`aria-describedby`,e.ariaDescribedby)(`aria-required`,e.required||null)(`aria-checked`,e.checked)(`aria-disabled`,e.disabled&&e.disabledInteractive?`true`:null),gI(9),Kp(`matRippleTrigger`,l)(`matRippleDisabled`,e.disableRipple||e.disabled)(`matRippleCentered`,!0),gI(),ID(e.hideIcon?-1:11),gI(),Kp(`for`,e.buttonId),Yp(`id`,e._labelId)}},dependencies:[La,ei],styles:[`.mdc-switch {
  align-items: center;
  background: none;
  border: none;
  cursor: pointer;
...
`],encapsulation:2})}return i})();var we=(()=>{class i{static ɵfac=function(a){return new(a||i)};static ɵmod=QE({type:i});static ɵinj=uu({imports:[te,qn]})}return i})();export{we as n,te as t};